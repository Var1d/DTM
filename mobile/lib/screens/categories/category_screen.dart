      ...
      builder: (_) => StatefulBuilder(builder: (ctx, setModal) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(width: double.infinity, child: ElevatedButton(
            onPressed: () async {
              final hex = '#${picked.value.toRadixString(16).substring(2)}';
              final prov = context.read<CategoryProvider>();
              if (id == null) {
                await prov.createCategory(nameCtrl.text.trim(), hex);
              } else {
                await prov.updateCategory(id, nameCtrl.text.trim(), hex);
              }
          ...
          return ListTile(
            ...
            trailing: Row(mainAxisSize: MainAxisSize.min, children: [
              IconButton(icon: const Icon(Icons.edit_outlined),
                onPressed: () => _showForm(id: c.id, name: c.name, color: c.color)),
